    ...
    <div class="nav-container">
        ...
        <div class="user-menu">
            <div class="user-dropdown">
                <span class="user-name" onclick="toggleUserDropdown(event)"><i class="fas fa-user-circle"></i><span><?= htmlspecialchars($this->session->userdata('full_name') ?: $this->session->userdata('username')) ?></span> <i class="fas fa-chevron-down" style="font-size: 10px; margin-left: 2px; opacity: 0.7;"></i></span>
                <div id="userDropdownMenu" class="dropdown-menu">
                    <a href="<?= base_url('profile') ?>" class="dropdown-item"><i class="fas fa-tachometer-alt"></i> Dashboard Profile</a>
                    <a href="<?= base_url('auth/logout') ?>" class="dropdown-item"><i class="fas fa-sign-out-alt"></i> Logout</a>
                </div>
            </div>
